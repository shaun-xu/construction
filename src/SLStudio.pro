...
unix:!macx {
    ...
    LIBS += -lboost_system -lpcl_visualization -lpcl_common -lpcl_io -lpcl_search -lpcl_surface -Wl,-rpath=/opt/MVS/lib/64 -L/opt/MVS/lib/64 -lMvCameraControl
    # PKG-config libs
    INCLUDEPATH += /usr/include/pcl-1.8 /usr/include/eigen3/ /opt/MVS/include
